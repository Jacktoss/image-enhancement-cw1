...
# show this to display noisy image in the frequency domain
...
'''
To show clean magnitude spectrum:
display_ms(ms_np)

Magnitude spectrum used because unlike with complex values it is easier
to interpret its noise
